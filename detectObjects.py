...
if __name__ == "__main__":
    model_path = '/home/lee/motionDetector/ssd_mobilenet_v1_coco_2017_11_17/frozen_inference_graph.pb'
    ...
    while True:
        ...
        for i in range(len(boxes)):
            if scores[i] > threshold:
                ...
                cv2.putText(img, "This is a " + className, (box[1],box[0]), 1, 2.0, (255, 255, 255))
